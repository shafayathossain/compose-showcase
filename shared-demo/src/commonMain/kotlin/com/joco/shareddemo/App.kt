...
import com.joco.shareddemo.dialog.MyArrowDialog
import com.joco.shareddemo.dialog.SkeletonArrowDialog
import com.joco.shareddemo.dialog.TransparentDialog
import com.joco.shareddemo.ui.theme.ComposeShowcaseTheme
...
import compose_showcase.shared_demo.generated.resources.label_greetings
...
fun Greeting(modifier: Modifier = Modifier, name: String, onClick: () -> Unit) {
    Text(
        text = stringResource(Res.string.label_greetings, name),
